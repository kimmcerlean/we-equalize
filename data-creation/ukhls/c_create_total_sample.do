...
sort pidp year
browse pidp year partnered partner_id partner_match sex sex_sp howlng howlng_sp jbhrs jbhrs_sp  hubuys hubuys_sp age_all age_all_sp hh_weight hh_weight_sp

gen check_hh_weight=.
replace check_hh_weight = 0 if hh_weight!=hh_weight_sp & hh_weight!=. & hh_weight_sp!=.
replace check_hh_weight = 1 if hh_weight==hh_weight_sp & hh_weight!=. & hh_weight_sp!=.
...
local hhvars "hhsize fihhmngrs_dv hrpid ncouple_dv nkids_dv nch02_dv nch34_dv nch511_dv nch1215_dv agechy_dv npens_dv nemp_dv tenure_dv nchild_015 hhdenus_xw hhdenub_xw hh_weight hh_gross_labor_income hh_net_labor_income"
